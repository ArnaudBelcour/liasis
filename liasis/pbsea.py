...
class PandasEnrichmentAnalysis():
    ...
    def __init__(self, dataframe, name_column_interest, name_column_reference, number_of_object_of_interest, number_of_genes_in_reference, alpha, threshold_normal_approximation):
        self.dataframe = dataframe
        self._output_columns = [name_column_interest, name_column_reference, 'PercentageInInterest', 'PercentageInReference',
                                 'pvalue_hypergeometric', 'pValueBonferroni', 'pValueHolm', 'pValueBenjaminiHochberg',
                                 'pValueBenjaminiYekutieli']
    ...
    def hypergeometric_test_on_dataframe(self, df, reference_column):
    ...
    def compute_normal_approximation(self, row, reference_column):
        number_of_object_in_interest = row[self.column_interest]
    ...
    def enrichment_analysis(self):
        ...
        dataframe_used = self.hypergeometric_test_on_dataframe(dataframe_used, self.column_reference)
